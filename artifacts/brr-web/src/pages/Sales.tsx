          ...
          <table className="w-full min-w-[1400px] border-separate border-spacing-0">
            <thead className="sticky top-0 z-20 bg-secondary shadow-sm">
              <tr className="bg-secondary border-b-2 border-border">
                ...
                <th ref={thBrandNoRef} className="table-header w-[30px] min-w-[30px] whitespace-nowrap border-r border-border sticky top-0 z-30 bg-secondary" style={{ left: colLeft.brandNo }}>
                ...
                paginatedSales.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className={`table-cell w-[30px] min-w-[30px] whitespace-nowrap font-mono text-xs text-muted-foreground border-r border-border sticky z-10 ${rowBg} group-hover:bg-[#fff5f4]`} style={{ left: colLeft.brandNo }}>
                        {item.brandNumber}
                      </td>
